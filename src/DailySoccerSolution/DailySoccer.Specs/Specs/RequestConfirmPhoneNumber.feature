...
#ผู้ใช้ทำการขอยืนยันเบอร์โทรศัพท์แต่เป็นเบอร์ที่เคยขอยืนยันไปแล้ว (เบอร์โทรนั้นยังไม่เคยยืนยัน) ระบบบันทึกเบอร์โทรแล้วส่งรหัสลับในการยืนยันกลับไป
#ผู้ใช้ทำการขอยืนยันเบอร์โทรศัพท์แต่เป็นเบอร์ที่เคยขอยืนยันไปแล้ว (เบอร์โทรนั้นเคยยืนยันไปแล้ว) ระบบบันทึกเบอร์โทรแล้วส่งรหัสลับในการยืนยันกลับไป