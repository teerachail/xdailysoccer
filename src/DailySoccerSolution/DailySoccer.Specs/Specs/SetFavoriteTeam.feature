...
#ผู้ใช้ไม่เลือกทีมที่ชอบ ระบบไม่ทำการบันทึกข้อมูล
#ผู้ใช้เลือกทีมที่ชอบที่ไม่มีในระบบ ระบบไม่ทำการบันทึกข้อมูล
#ผู้ใช้ที่ข้อมูลไม่ถูกต้องทำการเลือกทีมที่ชอบ ระบบไม่ทำการบันทึกข้อมูล